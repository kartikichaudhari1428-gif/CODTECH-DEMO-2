...
This project demonstrates a simple Natural Language Generator (NLG) using random word selection.
It generates sentences by combining subjects, verbs, objects, and adverbs.
